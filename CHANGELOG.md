...
## [1.4.1] - 2024-04-26
### Fixed
- *fieldLinkDepths* parameter is required in the querystring and not the body, when falling back to POST method in entries search
...
- export models in main package export
### Fixed
- incorrect url used in *getAncestorsAtLevel* nodes method

## [1.3.1] - 2024-02-20
### Changed
- updated logic for switching to POST to avoid hitting URL length limits.
