...
const nodes_operations_1 = require("../nodes/nodes-operations");
class Client {
    constructor(config = null) {
        this.clientConfig = null;
        this.clientConfig = new client_config_1.ClientConfig(config, Client.defaultClientConfig);
        this.httpClient = new http_client_1.HttpClient(this);
        ...
        this.nodes = new nodes_operations_1.NodesOperations(this.httpClient, this);
