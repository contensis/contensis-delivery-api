...
exports.TaxonomyOperations = void 0;
...
class TaxonomyOperations {
    ...
    resolveChildren(node) {
        ...
        if (typeof taxonomyNodeOrKey === 'string') {
            return this.getNodeByKey(Object.assign(Object.assign({}, getNodeByKeyOptions), { key: taxonomyNodeOrKey }));
        }
        if (!taxonomyNodeOrKey.hasChildren) {
            return Promise.resolve(Object.assign(Object.assign({}, taxonomyNodeOrKey), { children: [] }));
        }
        ...
        return this.getNodeByKey(Object.assign(Object.assign({}, getNodeByKeyOptions), { key: taxonomyNodeOrKey.key }));
    }
}
