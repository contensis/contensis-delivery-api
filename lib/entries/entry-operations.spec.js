...
const ExpressionTimePrecision_1 = require("contensis-core-api/lib/models/search/ExpressionTimePrecision");
...
describe('Entry Operations', function () {
    ...
    describe('Search entries', () => {
        ...
        it('Do Search with truncated dates using a Query instance', async () => {
            ...
            const client = Client.create((0, specs_utils_spec_1.getDefaultConfigForAccessToken)());
            ...
            Op.greaterThanOrEqualTo('truncatedMs', '2026-02-09T00:00:00.999', ExpressionTimePrecision_1.ExpressionTimePrecisionEnum.Seconds), Op.greaterThan('nonDate', 6));
            query.pageIndex = 1;
            query.pageSize = 50;
            await client.entries.search(query, 99);
            const expectedQueryString = (0, contensis_core_api_1.toQuery)({
                pageIndex: 1,
                pageSize: 50,
                where: JSON.stringify([{
                        field: 'exactDate',
