...
type ExpressionTimePrecision = 'minutes' | 'seconds' | 'exact';
declare const ExpressionTimePrecisionEnum: {
    Minutes: ExpressionTimePrecision;
    Seconds: ExpressionTimePrecision;
    Exact: ExpressionTimePrecision;
};

var ExpressionTimePrecisionEnum = {
    Minutes: 'minutes',
    Seconds: 'seconds',
    Exact: 'exact'
};
//# sourceMappingURL=ExpressionTimePrecision.js.map
{"version":3,"file":"ExpressionTimePrecision.js","sourceRoot":"","sources":["../../../src/models/search/ExpressionTimePrecision.ts"],"names":[],"mappings":"AAEA,MAAM,CAAC,IAAM,2BAA2B,GAAG;IACvC,OAAO,EAAE,SAAoC;IAC7C,OAAO,EAAE,SAAoC;IAC7C,KAAK,EAAE,OAAkC;CAC5C,CAAC"}
